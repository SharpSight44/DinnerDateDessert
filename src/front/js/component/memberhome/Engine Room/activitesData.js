...
export const doral= [{name:"City Place", image_url:"https://images.miamiandbeaches.com/crm/simpleview/image/upload/w_1440,h_900,c_fit/crm/miamifl/CityPlace-Doral01_7c4084c4-5056-a36a-0bbe6f3beca4f23a.jpg", description:"At CityPlace Doral, you’ll find an expansive collection of dining options, from upscale restaurants to outdoor cafés and bistros. With so many options to choose from, you’ll definitely find whatever your heart desires."}];
 ...
 export const soho = [{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""}];

 export const upperEastSide = [{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""}];

 export const brooklyn= [{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""},{name:"",image_url:"", description:""}];
